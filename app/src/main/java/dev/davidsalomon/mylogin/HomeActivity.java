...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Actualizar el header del Navigation Drawer con los datos del usuario
        ...
        if (tvHeaderName != null && fullName != null) {
            tvHeaderName.setText(fullName);
        }

        if (tvHeaderEmail != null && username != null) {
            tvHeaderEmail.setText(username);
        }
    }
